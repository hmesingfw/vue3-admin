...
export default {
    ...
    data() {
        return {
            ...
            tableParams: [
                { prop: 'selection', label: '选择', attr: { type: 'selection', width: 46 } },
                ...
                {
                    prop: 'size', label: '文件大小', attr: { width: 100, },
                },
                {
                    prop: 'md5', label: 'x张三',
            ...
            queryParams: [
                ...
                { label: '姓名：', prop: 'name', type: 'input' },
                {
                    label: '性别：', prop: 'sex', type: 'select', option: [{ label: '男', value: 1 }, { label: '女', value: 2 }]
                }, {
                    formatF: () => <div>
                        <el-button type='text' onClick={() => this.query()} icon='el-icon-delete'>查询</el-button>
                    </div>
                },
            ],
